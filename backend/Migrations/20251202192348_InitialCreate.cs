    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_favorite_movie = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_favorite_movies", x => x.id_favorite_movie);
                    table.ForeignKey(
                        name: "FK_favorite_movies_users_user_id_favorite_movie",
                        column: x => x.user_id_favorite_movie,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_favorite_movies_user_id_favorite_movie",
